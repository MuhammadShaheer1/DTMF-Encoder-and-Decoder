...
set(buttonSoundAll,'String','SoundAll','Position',[bip+[0 -bs*4],bs*3,bs],'BackgroundColor',[0.839 0.91 0.851]); % Property
...
set(buttonClear,'String','Clear','Position',[bip+[0 -bs*5],bs*3,bs],'BackgroundColor',[0.937 0.867 0.867]); % Property
...
set(buttonDecode,'String','Decode','Position',[bip+[0 -bs*6],bs*3,bs],'BackgroundColor',[0.992 0.918 0.796]); % Property
